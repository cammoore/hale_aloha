...
Template.last12.onRendered(function () {
    ...
    //console.log(towerId);
    var records = Monthly.find({"tower": towerId, "lounge": {$exists: false}}, {fields: {value: 1}}).fetch();
    //console.log(records);
    var width = document.getElementById(towerId + "last12_chart").clientWidth;
    var height = document.getElementById(towerId + "last12_chart").clientHeight;
    var w = width;
    var h = height;
    ...
    var svg = d3.select("#" + towerId + "Last12Chart")
        .attr("width", width)
        .attr("height", height);
